...
// Test Routes untuk Development (Opsional)
if (app()->environment('local')) {
    Route::get('/test-route', function () {
        return response()->json([
            'routes' => [
                'video-questions' => route('admin.kursus.materials.video-questions', ['kursus' => 1, 'material' => 1]),
                'video-preview' => route('admin.kursus.materials.video-preview', ['kursus' => 1, 'material' => 1]),
                'video-stats' => route('admin.kursus.materials.video-stats', ['kursus' => 1, 'material' => 1]),
            ]
        ]);
    });
}